package com.demand.goodbuddy.note.detail.nonsmoking;
...
public class NoteNonSmokingActivity extends Activity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_nonsmoking);
...
//                startActivity(intent);
    ...
    public void reformView(){
        ...
        sv_note = (ScrollView)findViewById(R.id.sv_note_5_1);
        //
        ...
        tv_content_title.setText("금연/절주");
        //
