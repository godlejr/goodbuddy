package com.demand.goodbuddy.note.detail.pressure;
...
public class NotePressureActivity extends Activity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_pressure);
...
//                startActivity(intent);
    ...
    public void reformView(){
        ...
        sv_note = (ScrollView)findViewById(R.id.sv_note_6);
        //
        ...
        tv_content_title.setText("혈압 관리");
        //
