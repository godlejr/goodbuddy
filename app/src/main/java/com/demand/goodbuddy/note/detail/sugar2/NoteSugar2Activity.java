package com.demand.goodbuddy.note.detail.sugar2;
...
public class NoteSugar2Activity extends Activity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_sugar2);
...
//                startActivity(intent);
    ...
    public void reformView(){
        ...
        sv_note = (ScrollView)findViewById(R.id.sv_note_7_2);
        //
        ...
        tv_content_title.setText("혈당 관리 II");
        //
