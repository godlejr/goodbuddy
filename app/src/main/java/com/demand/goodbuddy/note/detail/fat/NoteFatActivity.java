package com.demand.goodbuddy.note.detail.fat;
...
public class NoteFatActivity extends Activity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_fat1);
...
//                startActivity(intent);
    ...
    public void reformView(){
        ...
        sv_note = (ScrollView)findViewById(R.id.sv_note_1);
        ...
        tv_content_title.setText("비만 예방/관리");
        //
