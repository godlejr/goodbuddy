package com.demand.goodbuddy.note.detail.stress;
...
public class NoteStressActivity extends Activity {
    /**
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_stress);
...
//                startActivity(intent);
    ...
    public void reformView(){
        ...
        sv_note = (ScrollView)findViewById(R.id.sv_note_4);
        //
        ...
        tv_content_title.setText("스트레스 관리");
        //
        ...
        functions.resizeViewAll(tv_round, length_4, "linear", .9444, .12, 0, 0, 0, 0);
    }
