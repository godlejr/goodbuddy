package com.demand.goodbuddy.note.detail.exercise2;
...
public class NoteExercise2Activity extends Activity {
    /**
...
//                startActivity(intent);
    ...
    public void reformView(){
        ...
        sv_note = (ScrollView)findViewById(R.id.sv_note_3_2);
        //
        ...
        tv_content_title.setText("운동 관리 II");
        //
